...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dateme_app_person', (
            ...
            ('isValidated', self.gf('django.db.models.fields.BooleanField')()),
    ...
    models = {
        ...
        u'dateme_app.conversation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subscriber': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        ...
        u'dateme_app.person': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isValidated': ('django.db.models.fields.BooleanField', [], {}),
